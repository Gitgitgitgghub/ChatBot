...
class CollectionViewLeftAlignedLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        if let attributes = super.layoutAttributesForItem(at: indexPath), let currentItemAttributes = attributes.copy() as? UICollectionViewLayoutAttributes, let collection = collectionView {
